...
export function fetchAllFlights() {
  ...
  /**
   * Base URL for seats-related API calls.
   */
  export const API_URL = 'http://localhost:8080/seats';
  ...
  export function confirmSeatsApi(selectedSeats) {
    // Map each seat to a booking fetch promise and wait for all to complete.
    return Promise.all(
